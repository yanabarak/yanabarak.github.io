...
<p class="dayq">Старт 1 сентября. Онлайн курс. 12 недель + призы и бонусы.</p>
...
<br><span class="fa-color">120 дней (90 дней марафон + 30 дней доступ к материалам)</span></span>
				...
				<div class="mtable" >
					...
					<div class="fline">
						...
						<div class="fcol2 fa-color"><div class="text2">249$<br>6549грн<br>15190руб</div><a href="https://mamahudeet.com/forma/?packet=2<?php echo $utmurl ?>"><div class="fbtn goto">Хочу участвовать</div></a></div>
...
"><div class="fbtn goto">Хочу участвовать</div></a></div>
						<div class="fcol4 fa-color"><div class="text2">1199$<br>31600грн<br>73600руб</div><a href="https://mamahudeet.com/forma/?packet=5<?php echo $utmurl ?>"><div class="fbtn goto">Хочу участвовать</div></a></div>
					</div>
					<div class="fline">
...
<footer>
		...
		</footer>	<div class="yvedw">
			<div class="yved yvedf1">
			<div class="yvedvt"><div class="yvedt">Марина только что оставил(а) заявку на пакет Gold</div></div>
		</div>
			<div class="yved yvedf1">
			<div class="yvedvt"><div class="yvedt">Светлана Маланюк  оплатил(а) пакет Gold</div></div>
		</div>
			<div class="yved yvedf2">
			<div class="yvedvt"><div class="yvedt">Виктория Колодий оставил(а) заявку на обратный звонок.</div></div>
		</div>
			<div class="yved yvedf2">
			<div class="yvedvt"><div class="yvedt">Карина Авдеевa ооставил(а) заявку на пакет Gold</div></div>
		</div>
			<div class="yved yvedf2">
			<div class="yvedvt"><div class="yvedt">Яна оплатил(а) пакет Gold</div></div>
		</div>
			<div class="yved yvedf1">
			<div class="yvedvt"><div class="yvedt">Мирослава Сазоненко оставил(а) заявку на пакет Gold</div></div>
		</div>
			<div class="yved yvedf1">
			<div class="yvedvt"><div class="yvedt">Марія Лещенко оплатил(а) пакет Gold</div></div>
		</div>
			<div class="yved yvedf1">
			<div class="yvedvt"><div class="yvedt">Валерия Гузенко только что оставил(а) заявку на пакет Diamond</div></div>
		</div>
			<div class="yved yvedf2">
			<div class="yvedvt"><div class="yvedt">Александра Тимошенко оставил(а) заявку на обратный звонок.</div></div>
		</div>
			<div class="yved yvedf1">
			<div class="yvedvt"><div class="yvedt">Дарья Бутенко оплатил(а) пакет Diamond</div></div>
		</div>
