    ...
    window.onload = function() {
      ...
      setTimeout(function() {
        setInterval(
          function() {
            i = i + 1;
            if (i > 10) i = 1; // количество уведомлений
            $('.yved:nth-child(' + i + ')').fadeIn(500).delay(5000).fadeOut(500); //В этой строчке в мс 500 - время анимации появления, 5000 - время задержки, 500 - время затухания уведомления соответсвенно
          }, 90000); //25000 - задержка в мс между показами уведомлений
        yved();
      }, 50000); //10000 - задержка в мс перед показом первого уведомления
    }
  </script>
<script type="text/javascript">
...
<body>
  ...
  <div class="main-content">
    <header class="main-head">
      <div class="container">
        <div class="h-text">
          <img src="img/logolg.svg" style="max-width: 200px;margin-top: 0px;margin-bottom: 40px;" class="hidden-sm">
          <img src="img/logo.svg" style="max-width: 200px;margin: 0px auto;margin-bottom: 25px;" class="hidden-lg">
          <p class="dayq">Старт 30 сентября. Онлайн курс. 12 недель + призы и бонусы.</p>
          <h2>Сбрось легко и просто лишние <span class="red"> 6 - 35 кг </span> меньше чем <span class="sel"><img src="img/selection (2).png" alt=""><span>за 3 месяца</span></span> продолжая есть любимую еду, без зала и беговой дорожки<!-- <span class="red">10 - 60 сантиметров</span> меньше чем <span class="sel"><img src="img/selection (2).png" alt=""><span> за 3 месяца!</span></span> --></h2>
          <h4>Участвуй в авторском 90-дневном курсе похудения для мам по инновационному  “МЕТОДУ М7™”, что был успешно проверен более чем на 200 мамах
          </h4>
    ...
    <section class="s1">
      <div class="container">
        <div class="d14">
          <h5 style="
    margin: 20px 0 0px 0;padding-bottom: 0px;
">Академия “Мама Xудеет” разработала пошаговый <span class="sel"><img src="img/selection.png" style="width: 260px; height: 33px; display: block !important" alt=""><span>90-дневный курс</span></span> специально для мам, пожертвовавших ради семьи своим самым святым - телом и красотой.</h5>
        </div>
        <div class="days-wrap">
          <div class="days">
            <div class="text">
    ...
    <section class="s2">
      <div class="container">
        <div class="s2-items">
          <div class="s2-item">
            <h3><span class="red">Только представь:</span></h3>
            <ul>
              <li>в любом весе и состоянии,</li>
              <li>без отрывы от бытовых дел и малыша.</li>
            </ul>
            <h5>Ты погружаешься в 90-дневный курс по МЕТОДУ М7™ с программой, индивидуально создающейся еженедельно под тебя. </h5>
          </div>
        ...
        <div class="s2-items" style="padding-bottom: 0px">
          ...
          <p><span class="red">По опыту пoxудевших мам</span>, если ты сделаешь хотя бы половину того, что делают остальные участницы курса, - уже на второй неделе 3-месячного курса у тебя останется <span class="red">только одна забота</span> - найти хорошую швею, чтобы постоянно<span class="red"> ушивать и приталивать одежду! </span>.</p>
    ...
    <section class="s1">
      <div class="container">
        <div class="days-wrap">
          <blockquote>
            <p>Участвуя в курсе, ты за 3 месяца создашь <span>идеальную форму </span>под наблюдением экспертов Академии “Мама xудеет” (диетологов, тренеров, психологов, которые не дадут тебе <del>расслабиться</del>;))</span></p>
      ...
      <div class="container">
        ...
        <div class="s4-items">
          ...
          <ul class="cards">
            ...
            <h5 style="margin-top: 40px">Специально для этого нашел из сотни тренеров волшебницу. </h5>
            <p class="card__text good"> На ее онлайн курсах уже пoxудели более 200 мам. Пройти мимо благодарственных отзывов постройневших женщин и их мужей было невозможно. И я горжусь, что нашел действительно лучшего тренера в СНГ, маму и женщину, понимающую других мам без слов.</p>
            <li class="cards__item">
              <div class="card">
        ...
        <div class="container-fluid">
          ...
          <div class="mtable">
            ...
            <div class="nline">
              ...
              <div class="ncol2 red">-</div>
              <div class="ncol3 fa-color">+<br>2 часа</div>
              <div class="ncol4 fa-color">+<br>2 часа</div>
            </div>
            ...
            <div class="nline">
              ...
              <div class="ncol2 red">-</div>
              <div class="ncol3 red">-</div>
              <div class="ncol4 fa-color">+<br>4 часа</div>
            </div>
            <div class="nline">
            ...
            <div class="fline">
              ...
              <div class="fcol2 ">
                <div class="text1">399$</div>
              </div>
              <div class="fcol3 ">
                <div class="text1">499$</div>
              </div>
              <div class="fcol4 ">
                <div class="text1">1980$</div>
              </div>
            </div>
            ...
            <div class="fline">
              ...
              <div class="fcol2">
                <div class="text2">38%</div>
              </div>
              <div class="fcol3">
                <div class="text2">49%</div>
              </div>
              <div class="fcol4">
                <div class="text2">39%</div>
              </div>
            </div>
            <div class="fline">
            ...
            <div class="fline">
              ...
              <div class="fcol2 fa-color">
                <div class="text2">249$<br>6549грн<br>15190руб</div><a href="https://mamahudeet.com/forma/?packet=2<?php echo $utmurl ?>"><div class="fbtn goto">Хочу участвовать</div></a></div>
...
"><div class="text2" style="
    position:  relative;
    top: -20px;
">249$<br>6549грн<br>15190руб</div><a href="https://mamahudeet.com/forma/?packet=2<?php echo $utmurl ?>" style="
    position:  relative;
    top: -20px;
"><div class="fbtn goto">Хочу участвовать</div></a></div>
              <div class="fcol4 fa-color">
                <div class="text2">1199$<br>31600грн<br>73600руб</div><a href="https://mamahudeet.com/forma/?packet=5<?php echo $utmurl ?>"><div class="fbtn goto">Хочу участвовать</div></a></div>
            </div>
            <div class="fline">
              <div class="fcol1">Осталось мест:</div>
              <div class="fcol2">
                <div class="text2">18 из 100</div>
              </div>
              <div class="fcol3">
                <div class="text2">9 из 70</div>
              </div>
              <div class="fcol4">
                <div class="text2">11 из 30</div>
              </div>
            </div>
            <div class="fline">
    ...
    <section class="s4 rect"> <div class="container iron"   style="outline: 1px solid black;">
        <h5>Клиентка академии “Мама Худеет” - всегда права.<br><span style="font-size: 18px;color: #696969;font-weight: 400;">ЖЕЛЕЗНАЯ ГАРАНТИЯ, тысяча чертей!<br>90 Дневная Гарантия Возврата!</span></h5>
  ...
  align-items: center;">
            <div class="text">
              ...
              <ol class="iron">
                <li><span class="red">ЖЕЛЕЗНАЯ ГАРАНТИЯ </span>- это когда ты остаешься нашей любимой клиенткой и ПОСЛЕ того, как вернула деньги за курс</li>
                <li><span class="red">ЖЕЛЕЗНАЯ ГАРАНТИЯ </span>- это простая возможность вернуть в течении 90 дней купленный курс, если он, к примеру, не подошел к тебе, или не оправдал ожидания</li>
                <li>Да, <span class="red">причины не важны </span>- не нравиться и все, деньги вернем по стандартной процедуре и без лишних вопросов </li>
              </ol>
            </div>
          </div>
      </div>  <img src="img/pechat.png" alt="" id="pechat">
      <div class="container">
        <h5 style="margin-top: 40px;">Наши призы:</h5>
        <svg class="arrow">
          <path class="a1" d="M0 0 L30 22 L60 0"></path>
          <path class="a2" d="M0 20 L30 42 L60 20"></path>
          <path class="a3" d="M0 40 L30 62 L60 40"></path></svg>
  ...
  align-items: center;">
    ...
    <section class="s4 rect s42">
      <div class="container">
        <div class="s4-items">
          ...
          <h5 style="margin-top: 40px;padding-bottom: 40px">Звучит справедливо?<br> Академия “Мама Xудеет” ждет тебя на курсе.<br>
          ...
          <div class="w3-content w3-display-container owl-carousel owl-theme" id="div1">
            ...
            <div class="swiper-slide">
              ...
              <div class="text slider">
                ...
                <p>Результат в см: -30 см всего в объёмах</p>
              </div>
            </div>
            <div class="swiper-slide"> <iframe width="100%" height="400" src="https://www.youtube.com/embed/JNVCsHZ_Iio?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> <div class="text slider">
                <h3>Нарине (г. Киев)</h3>
                <p>Возраст: 30 лет</p>
                <p>Семейное положение: замужем</p>
                ...
                <p>Результат в см: -35 см всего в объёмах</p>
              </div>
            </div>
            <div class="swiper-slide"> <iframe width="100%" height="400" src="https://www.youtube.com/embed/LBCmjogMoRk?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> <div class="text slider">
                <h3>Оля (г. Черновцы)</h3>
                <p>Возраст: 28 лет</p>
                <p>Семейное положение: замужем</p>
            ...
            <div class="swiper-slide"> <iframe width="100%" height="400" src="https://www.youtube.com/embed/OfZaTEuKlLg?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> <div class="text slider">
                <h3>Света (г. Винница)</h3>
                <p>Возраст: 27 лет</p>
                <p>Семейное положение: замужем</p>
            ...
            <div class="swiper-slide"> <iframe width="100%" height="400" src="https://www.youtube.com/embed/xUgedryCO4w?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> <div class="text slider">
                <h3>Юлия (г. Киев)</h3>
                <p>Возраст: 32 года</p>
                <p>Семейное положение: замужем</p>
                ...
                <p>Результат в см: -40 см всего в объёмах</p>
              </div>
            </div>
            <div class="swiper-slide"> <iframe width="100%" height="400" src="https://www.youtube.com/embed/KZFqffLhda0?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> <div class="text slider">
                <h3>Маргарита (г. Угледар)</h3>
                <p>Возраст: 25 лет</p>
                <p>Семейное положение: замужем</p>
            ...
            <div class="swiper-slide"> <iframe width="100%" height="400" src="https://www.youtube.com/embed/t3Tm3jZV3ro?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> <div class="text slider">
                <h3>Елена (г. Киев)</h3>
                <p>Возраст: 32 года</p>
                <p>Семейное положение: замужем</p>
    ...
    <section class="s5">
      <div class="container">
        <div class="ghjl">
          ...
          <h2>О здоровье и твоих особенностях</h2>
          <ul class="accordion">
            <li>
          ...
          <ul class="accordion">
            ...
            <li>
              ...
              <p>Это будет зависеть от пакета, который ты приобретешь.<br> Silver: 120 дней (90 дней курс + 30 дней доступ к материалам).<br> Gold: 120 дней (90 дней курс + 30 дней доступ к материалам).<br> Diamond: безлимит (90 дней курс + вечный доступ к материалам).
    ...
    <section class="question-box container ios">
      <div class="from-them">
        <p class="question-box__txtGray question-box__txtGray_1">Можно ли оплатить полностью?</p>
      </div>
      <div class="clear"></div>
      <div class="from-me">
        <p class="question-box__txtBlack question-box__txtBlack_1">Будет ли у меня результат?</p>
      </div>
      <div class="clear"></div>
      <div class="from-them">
        <p class="question-box__txtGray question-box__txtGray_2">А можно забронировать пакет?</p>
      </div>
      <div class="clear"></div>
      <div class="from-me">
        <p class="question-box__txtBlack question-box__txtBlack_2">Я беременная, но хочу участвовать...</p>
      </div>
      <div class="clear"></div>
      <div class="from-them">
        <p class="question-box__txtGray question-box__txtGray_3">Я участвовала в марафонах − не получилось. Как и что делать дальше?</p>
      </div>
      <div class="clear"></div>
      <div class="from-me">
        <p class="question-box__txtBlack question-box__txtBlack_2">Как быть, если я хочу участвовать позже?</p>
      </div>
      <div class="clear"></div>
    </section>
    ...
    <footer>
      <div class="links social">
        <a href="https://www.facebook.com/mamahudeet.ilkov/"  target="_blank"><img src="img/icon (5).png" alt=""></a>
        <a href="https://www.instagram.com/sergey_ilkov/" target="_blank"><img src="img/icon (6).png" alt=""></a>
      </div>
      <p>По всем вопросам: <a href="mailto:info@mamahudeet.com" target="_blank"> info@mamahudeet.com</a></p>
      <p><a href="tel:+380673290392" target="_blank">+380673290392(Украина)</a></p>
      <p><a href="tel:+79587568901" target="_blank">+79587568901(Россия)</a></p>
      <div class="links social">
        <a href="tg://resolve?domain=mamahudeetsuport" target="_blank"><img src="img/icon (1).png" alt=""></a>
        <a href="whatsapp://send?phone=+380673290392" target="_blank"><img src="img/icon (2).png" alt=""></a>
        <a href="viber://add?number=+380673290392" target="_blank"><img src="img/icon (3).png" alt=""></a>
      </div>
      <p><a href="tel:+380673290392" target="_blank">+380673290392 </a></p>
      <div class="links">
        <a href="https://mamahudeet.com/info/politica.pdf" target="_blank">Политика конфиденциальности</a>
        <a href="https://mamahudeet.com/info/dogovor.pdf" target="_blank">Договор оферты </a>
        <a href="https://mamahudeet.com/info/rassilka.pdf" target="_blank">Согласие с рассылкой</a>
      </div>
    ...
    <div class="yvedw">
      <div class="yved yvedf1">
        <div class="yvedvt">
          <div class="yvedt">Марина только что оставил(а) заявку на пакет Gold</div>
        </div>
      </div>
      <div class="yved yvedf1">
        <div class="yvedvt">
          <div class="yvedt">Светлана Маланюк оплатил(а) пакет Gold</div>
        </div>
      </div>
      <div class="yved yvedf2">
        <div class="yvedvt">
          <div class="yvedt">Виктория Колодий оставил(а) заявку на обратный звонок.</div>
        </div>
      </div>
      <div class="yved yvedf2">
        <div class="yvedvt">
          <div class="yvedt">Карина Авдеевa ооставил(а) заявку на пакет Gold</div>
        </div>
      </div>
      <div class="yved yvedf2">
        <div class="yvedvt">
          <div class="yvedt">Яна оплатил(а) пакет Gold</div>
        </div>
      </div>
      <div class="yved yvedf1">
        <div class="yvedvt">
          <div class="yvedt">Мирослава Сазоненко оставил(а) заявку на пакет Gold</div>
        </div>
      </div>
      <div class="yved yvedf1">
        <div class="yvedvt">
          <div class="yvedt">Марія Лещенко оплатил(а) пакет Gold</div>
        </div>
      </div>
      <div class="yved yvedf1">
        <div class="yvedvt">
          <div class="yvedt">Валерия Гузенко только что оставил(а) заявку на пакет Diamond</div>
        </div>
      </div>
      <div class="yved yvedf2">
        <div class="yvedvt">
          <div class="yvedt">Александра Тимошенко оставил(а) заявку на обратный звонок.</div>
        </div>
      </div>
      <div class="yved yvedf1">
        <div class="yvedvt">
          <div class="yvedt">Дарья Бутенко оплатил(а) пакет Diamond</div>
        </div>
      </div>
