        ...
        <p class="card__text"> Милая, ты можешь проигнорировать это сообщение. Хотя уже через 90 дней после старта курса твоя фигура может окончательно трансформироваться и стать стройной. Но ты опять поставишь свои мечты на второе место, ведь главное - семья и ребенок. </p>
				...
				<h5 style="margin-top: 40px;padding-bottom: 40px">Звучит справедливо?<br> 
					...
					<span class="red">Регистрируйся сейчас!</span> Количество мест строго ограничено!</h5>
						...
						<button type="button" href="#packet"  class=" pulse" style="margin-top: 0px;">Точно участвую</button>
...
Diamond: безлимит (90 дней курс + вечный доступ к материалам).
		...
		<!-- 		<div class="pdf">
				...
				<div class="h-text">
					<button href="#packet"  class=" pulse"> Я хочу участвовать</button>
				</div>
...
<section class="question-box container ios">
	<div class="from-them">
				<p class="question-box__txtGray question-box__txtGray_1">Можно ли оплатить в рассрочку?</p></div>  <div class="clear"></div>
...
<footer>
			<div class="links social">
				<a href="https://www.youtube.com/channel/UCHvA2jaq2LwFUTVuoE5_Few?view_as=subscriber"><img src="img/icon (4).png" alt=""></a>
			...
			<p>Воронка создана в digital-marketing мастерской «F&nbsp;U&nbsp;N&nbsp;N&nbsp;E&nbsp;L™»</p><img src="img/Funnel.png">
