! function(e, t) {
    ...
    function p(e, t, n, r, i) {
        for (var o, a, s, u, l, p, d = t.createDocumentFragment(), h = [], m = 0, g = e.length; g > m; m++)
            if ((o = e[m]) || 0 === o)
                if ("object" === oe.type(o)) oe.merge(h, o.nodeType ? [o] : o);
                else if (qe.test(o)) {
            for (a = a || d.appendChild(t.createElement("div")), s = (He.exec(o) || ["", ""])[1].toLowerCase(), u = Oe[s] || Oe._default, a.innerHTML = u[1] + oe.htmlPrefilter(o) + u[2], p = u[0]; p--;) a = a.lastChild;
            oe.merge(h, a.childNodes), a = d.firstChild, a.textContent = ""
        } else h.push(t.createTextNode(o));
        for (d.textContent = "", m = 0; o = h[m++];)
            if (r && oe.inArray(o, r) > -1) i && i.push(o);
            else if (l = oe.contains(o.ownerDocument, o), a = c(d.appendChild(o), "script"), l && f(a), n)
            for (p = 0; o = a[p++];) Pe.test(o.type || "") && n.push(o);
        return d
    }
    ...
    function C(e, t, n, r) {
        ...
        var i, o, a, s, u, l, f = 0,
            ...
            m = t[0],
            g = oe.isFunction(m);
        if (g || d > 1 && "string" == typeof m && !re.checkClone && ze.test(m)) return e.each(function(i) {
            var o = e.eq(i);
            g && (t[0] = m.call(this, i, o.html())), C(o, t, n, r)
        });
        if (d && (i = p(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            for (a = oe.map(c(i, "script"), y), s = a.length; d > f; f++) u = i, f !== h && (u = oe.clone(u, !0, !0), s && oe.merge(a, c(u, "script"))), n.call(e[f], u, f);
            if (s)
                for (l = a[a.length - 1].ownerDocument, oe.map(a, x), f = 0; s > f; f++) u = a[f], Pe.test(u.type || "") && !ke.access(u, "globalEval") && oe.contains(l, u) && (u.src ? oe._evalUrl && oe._evalUrl(u.src) : oe.globalEval(u.textContent.replace($e, "")))
        }
        return e
    }
    ...
    function S(e, t, n) {
        ...
        return n = n || Ge(e), a = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== a && void 0 !== a || oe.contains(e.ownerDocument, e) || (a = oe.style(e, t)), n && !re.pixelMarginRight() && Ve.test(a) && Ye.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o), void 0 !== a ? a + "" : a
    }
    ...
    function I(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2) "margin" === n && (a += oe.css(e, n + Ie[o], !0, i)), r ? ("content" === n && (a -= oe.css(e, "padding" + Ie[o], !0, i)), "margin" !== n && (a -= oe.css(e, "border" + Ie[o] + "Width", !0, i))) : (a += oe.css(e, "padding" + Ie[o], !0, i), "padding" !== n && (a += oe.css(e, "border" + Ie[o] + "Width", !0, i)));
        return a
    }
    ...
    function D(t, n, r) {
        ...
        if (G.msFullscreenElement && e.top !== e && t.getClientRects().length && (o = Math.round(100 * t.getBoundingClientRect()[n])), 0 >= o || null == o) {
            if (o = S(t, n, a), (0 > o || null == o) && (o = t.style[n]), Ve.test(o)) return o;
    ...
    function L(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] = ke.get(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && De(r) && (o[a] = ke.access(r, "olddisplay", E(r.nodeName)))) : (i = De(r), "none" === n && i || ke.set(r, "olddisplay", i ? n : oe.css(r, "display"))));
    ...
    function M(e, t, n) {
        ...
        if (oe.isEmptyObject(f)) "inline" === ("none" === l ? E(e.nodeName) : l) && (p.display = l);
            ...
            for (r in f) a = q(d ? h[r] : 0, r, c), r in h || (h[r] = a.start, d && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    ...
    function _(e, t, n) {
        var r, i, o = 0,
            ...
            u = function() {
                if (i) return !1;
                for (var t = rt || P(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; u > a; a++) l.tweens[a].run(o);
    ...
    var ce = function(e) {
        function t(e, t, n, r) {
            var i, o, a, s, l, f, p, d, h = t && t.ownerDocument,
                m = t ? t.nodeType : 9;
            if (n = n || [], "string" != typeof e || !e || 1 !== m && 9 !== m && 11 !== m) return n;
            if (!r && ((t ? t.ownerDocument || t : F) !== I && j(t), t = t || I, L)) {
                if (11 !== m && (f = me.exec(e)))
                    if (i = f[1]) {
                        if (9 === m) {
                        ...
                        if ((i = f[3]) && x.getElementsByClassName && t.getElementsByClassName) return K.apply(n, t.getElementsByClassName(i)), n
                    }
                if (x.qsa && !W[e + " "] && (!H || !H.test(e))) {
                    if (1 !== m) h = t, d = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((s = t.getAttribute("id")) ? s = s.replace(ve, "\\$&") : t.setAttribute("id", s = M), p = T(e), o = p.length, l = ce.test(s) ? "#" + s : "[id='" + s + "']"; o--;) p[o] = l + " " + c(p[o]);
            ...
            return i && !i[M] && (i = m(i)), o && !o[M] && (o = m(o, a)), r(function(r, a, s, u) {
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (c = x.length; c--;)(f = x[c]) && (l = o ? Q(r, f) : p[c]) > -1 && (r[l] = !(a[l] = f))
                    }
            ...
            var i = n.length > 0,
                ...
                a = function(r, a, s, u, l) {
                    var c, f, p, d = 0,
                        ...
                        C = x.length;
                    for (l && (S = a === I || a || l); m !== C && null != (c = x[m]); m++) {
                        if (o && c) {
                            for (f = 0, a || c.ownerDocument === I || (j(c), s = !L); p = e[f++];)
                                if (p(c, a || I, s)) {
                                    u.push(c);
                                    break
                                }
        ...
        var y, x, b, w, C, T, k, E, S, N, A, j, I, D, L, H, P, O, q, M = "sizzle" + 1 * new Date,
            F = e.document,
            _ = 0,
            B = 0,
            R = n(),
        ...
        x = t.support = {}, C = t.isXML = function(e) {
            ...
            return r !== I && 9 === r.nodeType && r.documentElement ? (I = r, D = I.documentElement, L = !C(I), (n = I.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", be, !1) : n.attachEvent && n.attachEvent("onunload", be)), x.attributes = i(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), x.getElementsByTagName = i(function(e) {
                return e.appendChild(I.createComment("")), !e.getElementsByTagName("*").length
            }), x.getElementsByClassName = he.test(I.getElementsByClassName), x.getById = i(function(e) {
            ...
            }, P = [], H = [], (x.qsa = he.test(I.querySelectorAll)) && (i(function(e) {
            ...
            })), (x.matchesSelector = he.test(O = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && i(function(e) {
                x.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), P.push("!=", re)
            }), H = H.length && new RegExp(H.join("|")), P = P.length && new RegExp(P.join("|")), t = he.test(D.compareDocumentPosition), q = t || he.test(D.contains) ? function(e, t) {
                ...
                return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === I || e.ownerDocument === F && q(F, e) ? -1 : t === I || t.ownerDocument === F && q(F, t) ? 1 : N ? Q(N, e) - Q(N, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return A = !0, 0;
                var n, r = 0,
                    i = e.parentNode,
                    ...
                    s = [e],
                    u = [t];
                if (!i || !o) return e === I ? -1 : t === I ? 1 : i ? -1 : o ? 1 : N ? Q(N, e) - Q(N, t) : 0;
                if (i === o) return a(e, t);
            ...
            if ((e.ownerDocument || e) !== I && j(e), n = n.replace(ue, "='$1']"), x.matchesSelector && L && !W[n + " "] && (!P || !P.test(n)) && (!H || !H.test(n))) try {
                var r = O.call(e, n);
            ...
            filter: {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                for (p = g, f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === _ && l[1], x = d && l[2], p = d && g.childNodes[d]; p = ++d && p && p[m] || (x = d = 0) || h.pop();)
                                    if (1 === p.nodeType && ++x && p === t) {
                                        c[e] = [_, d, x];
                                        break
                                    }
                            } else if (y && (p = t, f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === _ && l[1], x = d), !1 === x)
                                for (;
                                    (p = ++d && p && p[m] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++x || (y && (f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[e] = [_, x]), p !== t)););
                ...
                PSEUDO: function(e, n) {
                    ...
                    return o[M] ? o(n) : o.length > 1 ? (i = [e, e, "", n], b.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, t) {
        ...
        return l.prototype = b.filters = b.pseudos, b.setFilters = new l, T = t.tokenize = function(e, n) {
            ...
            var n, r = [],
                ...
                o = W[e + " "];
            if (!o) {
                for (t || (t = T(e)), n = t.length; n--;) o = g(t[n]), o[M] ? r.push(o) : i.push(o);
                o = W(e, v(i, r)), o.selector = e
            }
            return o
        }, E = t.select = function(e, t, n, r) {
            var i, o, a, s, l, f = "function" == typeof e && e,
                p = !r && T(e = f.selector || e);
            if (n = n || [], 1 === p.length) {
                if (o = p[0] = p[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && x.getById && 9 === t.nodeType && L && b.relative[o[1].type]) {
            ...
            return (f || k(e, p))(r, t, !L, n, !t || ge.test(e) && u(t.parentNode) || t), n
        }, x.sortStable = M.split("").sort($).join("") === M, x.detectDuplicates = !!A, j(), x.sortDetached = i(function(e) {
    ...
    oe.extend({
        ...
        data: function(e, t) {
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                var n, r;
                if (o && void 0 === t) {
                    if (void 0 !== (n = Ee.get(o, e) || Ee.get(o, e.replace(Ne, "-$&").toLowerCase()))) return n;
    ...
    oe.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, a, s, u, l, c, f, p, d, h, m, g = ke.get(e);
            if (g)
                for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = oe.guid++), (u = g.events) || (u = g.events = {}), (a = g.handle) || (a = g.handle = function(t) {
                    ...
                    }), t = (t || "").match(be) || [""], l = t.length; l--;) s = _e.exec(t[l]) || [], d = m = s[1], h = (s[2] || "").split(".").sort(), d && (f = oe.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = oe.event.special[d] || {}, c = oe.extend({
                    type: d,
                    origType: m,
                    data: r,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, o), (p = u[d]) || (p = u[d] = [], p.delegateCount = 0, f.setup && !1 !== f.setup.call(e, r, h, a) || e.addEventListener && e.addEventListener(d, a)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, c) : p.push(c), oe.event.global[d] = !0)
        },
        remove: function(e, t, n, r, i) {
            var o, a, s, u, l, c, f, p, d, h, m, g = ke.hasData(e) && ke.get(e);
            if (g && (u = g.events)) {
                for (t = (t || "").match(be) || [""], l = t.length; l--;)
                    if (s = _e.exec(t[l]) || [], d = m = s[1], h = (s[2] || "").split(".").sort(), d) {
                        for (f = oe.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = u[d] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = p.length; o--;) c = p[o], !i && m !== c.origType || n && n.guid !== c.guid || s && !s.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (p.splice(o, 1), c.selector && p.delegateCount--, f.remove && f.remove.call(e, c));
                        a && !p.length && (f.teardown && !1 !== f.teardown.call(e, h, g.handle) || oe.removeEvent(e, d, g.handle), delete u[d])
                    } else
            ...
            if (s[0] = e, e.delegateTarget = this, !l.preDispatch || !1 !== l.preDispatch.call(this, e)) {
                for (a = oe.event.handlers.call(this, e, u), t = 0;
                    ...
                    for (e.currentTarget = i.elem, n = 0;
                        (o = i.handlers[n++]) && !e.isImmediatePropagationStopped();)(!e.rnamespace || e.rnamespace.test(o.namespace)) && (e.handleObj = o, e.data = o.data, void 0 !== (r = ((oe.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && !1 === (e.result = r) && (e.preventDefault(), e.stopPropagation()));
        ...
        fix: function(e) {
            ...
            var t, n, r, i = e.type,
                o = e,
                a = this.fixHooks[i];
            for (a || (this.fixHooks[i] = a = Fe.test(i) ? this.mouseHooks : Me.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new oe.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
    ...
    oe.extend({
        ...
        html: function(e) {
            return Ce(this, function(e) {
                ...
                if ("string" == typeof e && !Re.test(e) && !Oe[(He.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    ! function() {
        ...
        s.style && (s.style.backgroundClip = "content-box", s.cloneNode(!0).style.backgroundClip = "", re.clearCloneStyle = "content-box" === s.style.backgroundClip, a.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", a.appendChild(s), oe.extend(re, {
            ...
            reliableMarginRight: function() {
                ...
                return n.style.cssText = s.style.cssText = "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", n.style.marginRight = n.style.width = "0", s.style.width = "1px", Ze.appendChild(a), t = !parseFloat(e.getComputedStyle(n).marginRight), Ze.removeChild(a), s.removeChild(n), t
            }
        }))
    }();
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = oe.camelCase(t),
                    u = e.style;
                return t = oe.cssProps[s] || (oe.cssProps[s] = A(s) || s), a = oe.cssHooks[t] || oe.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = je.exec(n)) && i[1] && (n = l(e, t, i), o = "number"), void(null != n && n === n && ("number" === o && (n += i && i[3] || (oe.cssNumber[s] ? "" : "px")), re.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u[t] = n))))
            }
        },
        css: function(e, t, n, r) {
            var i, o, a, s = oe.camelCase(t);
            return t = oe.cssProps[s] || (oe.cssProps[s] = A(s) || s), a = oe.cssHooks[t] || oe.cssHooks[s], a && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = S(e, t, r)), "normal" === i && t in et && (i = et[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    }), oe.each(["height", "width"], function(e, t) {
        oe.cssHooks[t] = {
            get: function(e, n, r) {
                return n ? Qe.test(oe.css(e, "display")) && 0 === e.offsetWidth ? Ke(e, Je, function() {
                    return D(e, t, r)
                }) : D(e, t, r) : void 0
            },
            set: function(e, n, r) {
                ...
                return a && (i = je.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = oe.css(e, t)), j(e, n, a)
            }
        }
    ...
    oe.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? oe.prop(e, t, n) : (1 === o && oe.isXMLDoc(e) || (t = t.toLowerCase(), i = oe.attrHooks[t] || (oe.expr.match.bool.test(t) ? st : void 0)), void 0 !== n ? null === n ? void oe.removeAttr(e, t) : i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : i && "get" in i && null !== (r = i.get(e, t)) ? r : (r = oe.find.attr(e, t), null == r ? void 0 : r))
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    oe.fn.extend({
        addClass: function(e) {
            ...
            if ("string" == typeof e && e)
                for (t = e.match(be) || []; n = this[u++];)
                    if (i = B(n), r = 1 === n.nodeType && (" " + i + " ").replace(ft, " ")) {
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function(n) {
                ...
                else(void 0 === e || "boolean" === n) && (t = B(this), t && ke.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : ke.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, r = 0;
            for (t = " " + e + " "; n = this[r++];)
                if (1 === n.nodeType && (" " + B(n) + " ").replace(ft, " ").indexOf(t) > -1) return !0;
            return !1
        }
    });
    var pt = /\r/g;
    ...
    oe.extend(oe.event, {
        trigger: function(t, n, r, i) {
            ...
            if (a = s = r = r || G, 3 !== r.nodeType && 8 !== r.nodeType && !dt.test(d + oe.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[oe.expando] ? t : new oe.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : oe.makeArray(n, [t]), f = oe.event.special[d] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                if (!i && !f.noBubble && !oe.isWindow(r)) {
                    for (u = f.delegateType || d, dt.test(u + d) || (a = a.parentNode); a; a = a.parentNode) p.push(a), s = a;
                    s === (r.ownerDocument || G) && p.push(s.defaultView || s.parentWindow || e)
                }
                for (o = 0;
                    (a = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || d, c = (ke.get(a, "events") || {})[t.type] && ke.get(a, "handle"), c && c.apply(a, n), (c = l && a[l]) && c.apply && Te(a) && (t.result = c.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = d, i || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(p.pop(), n) || !Te(r) || l && oe.isFunction(r[d]) && !oe.isWindow(r) && (s = r[l], s && (r[l] = null), oe.event.triggered = d, r[d](), oe.event.triggered = void 0, s && (r[l] = s)), t.result
            }
        },
    ...
    St.href = ht.href, oe.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, s) {
                var l, f, y, x, w, T = n;
                2 !== b && (b = 2, u && e.clearTimeout(u), i = void 0, a = s || "", C.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, r && (x = $(p, C, r)), x = X(p, x, C, l), l ? (p.ifModified && (w = C.getResponseHeader("Last-Modified"), w && (oe.lastModified[o] = w), (w = C.getResponseHeader("etag")) && (oe.etag[o] = w)), 204 === t || "HEAD" === p.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = x.state, f = x.data, y = x.error, l = !y)) : (y = T, (t || !T) && (T = "error", 0 > t && (t = 0))), C.status = t, C.statusText = (n || T) + "", l ? m.resolveWith(d, [f, T, C]) : m.rejectWith(d, [C, T, y]), C.statusCode(v), v = void 0, c && h.trigger(l ? "ajaxSuccess" : "ajaxError", [C, p, l ? f : y]), g.fireWith(d, [C, T]), c && (h.trigger("ajaxComplete", [C, p]), --oe.active || oe.event.trigger("ajaxStop")))
            }
            ...
            if (m.promise(C).complete = g.add, C.success = C.done, C.error = C.fail, p.url = ((t || p.url || ht.href) + "").replace(vt, "").replace(Ct, ht.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = oe.trim(p.dataType || "*").toLowerCase().match(be) || [""], null == p.crossDomain) {
                l = G.createElement("a");
                try {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = oe.param(p.data, p.traditional)), z(Tt, p, n, C), 2 === b) return C;
            c = oe.event && p.global, c && 0 == oe.active++ && oe.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !wt.test(p.type), o = p.url, p.hasContent || (p.data && (o = p.url += (gt.test(o) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (p.url = yt.test(o) ? o.replace(yt, "$1_=" + mt++) : o + (gt.test(o) ? "&" : "?") + "_=" + mt++)), p.ifModified && (oe.lastModified[o] && C.setRequestHeader("If-Modified-Since", oe.lastModified[o]), oe.etag[o] && C.setRequestHeader("If-None-Match", oe.etag[o])), (p.data && p.hasContent && !1 !== p.contentType || n.contentType) && C.setRequestHeader("Content-Type", p.contentType), C.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Et + "; q=0.01" : "") : p.accepts["*"]);
    ...
    oe.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !oe(this).is(":disabled") && Dt.test(this.nodeName) && !It.test(e) && (this.checked || !Le.test(e))
            }).map(function(e, t) {
                var n = oe(this).val();
    ...
    oe.ajaxSetup({
        ...
        return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = oe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Ot, "$1" + i) : !1 !== t.jsonp && (t.url += (gt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
            return a || oe.error(i + " was not called"), a[0]
        }, t.dataTypes[0] = "json", o = e[i], e[i] = function() {
            a = arguments
        }, r.always(function() {
            void 0 === o ? oe(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Pt.push(i)), a && oe.isFunction(o) && o(a[0]), a = o = void 0
        }), "script") : void 0
    ...
    oe.fn.load = function(e, t, n) {
        ...
        oe.cssHooks[t] = N(re.pixelPosition, function(e, n) {
            return n ? (n = S(e, t), Ve.test(n) ? oe(e).position()[t] + "px" : n) : void 0
        })
    }), oe.each({
        Height: "height",
        Width: "width"
...
function(e) {
    ...
    v.prototype = {
        ...
        open: function(n) {
            ...
            C("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (b(l, function(e, t, n, r) {
                ...
                height: r.height(),
                position: "absolute"
            }), t.st.enableEscapeKey && r.on("keyup" + d, function(e) {
            ...
            return t.isIE7 && (v += " mfp-ie7"), v && t._addClassToMFP(v), t.updateItemHTML(), C("BuildControls"), e("html").css(m), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), t._lastFocusedEl = document.activeElement, setTimeout(function() {
                t.content ? (t._addClassToMFP(h), t._setFocus()) : t.bgOverlay.addClass(h), r.on("focusin" + d, t._onFocusIn)
            }, 16), t.isOpen = !0, t.updateSize(p), C(c), n
        },
        close: function() {
            t.isOpen && (C(u), t.isOpen = !1, t.st.removalDelay && !t.isLowIE && t.supportsTransition ? (t._addClassToMFP(m), setTimeout(function() {
                t._close()
        ...
        updateItemHTML: function() {
            ...
            if (C("BeforeChange", [t.currItem ? t.currItem.type : "", r]), t.currItem = n, !t.currTemplate[r]) {
                ...
                C("FirstMarkupParse", o), t.currTemplate[r] = !o || e(o)
            }
            i && i !== n.type && t.container.removeClass("mfp-" + i + "-holder");
            var a = t["get" + r.charAt(0).toUpperCase() + r.slice(1)](n, t.currTemplate[r]);
            t.appendContent(a, r), n.preloaded = !0, C(f, n), i = n.type, t.container.prepend(t.contentContainer), C("AfterChange")
        },
        ...
        _parseMarkup: function(t, n, r) {
            var i;
            r.data && (n = e.extend(r.data, n)), C(l, [t, n, r]), e.each(n, function(n, r) {
    ...
    var S, N, A, j = "inline",
        I = function() {
            A && (N.after(A.addClass(S)).detach(), A = null)
        };
            ...
            getInline: function(n, r) {
                if (I(), n.src) {
                    ...
                    if (o.length) {
                        ...
                        a && a.tagName && (N || (S = i.hiddenClass, N = w(S), S = "mfp-" + S), A = o.after(N).detach().removeClass(S)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(L, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(L), D = t.st.ajax.cursor, b(s + "." + L, P), b("BeforeChange." + L, P)
            },
            getAjax: function(n) {
                ...
                var r = e.extend({
                    ...
                    success: function(r, i, o) {
                        ...
                        C("ParseAjax", a), t.appendContent(e(a.data), L), n.finished = !0, H(), t._setFocus(), setTimeout(function() {
                            t.wrap.addClass(h)
        ...
        proto: {
            initImage: function() {
                ...
                t.types.push("image"), b(c + r, function() {
                    ...
                    n.cursor && e(document.body).removeClass(n.cursor), x.off("resize" + d)
    ...
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(n) {
                ...
                return F() ? s["-moz-transform"] = s.transform = "translate(" + i.left + "px," + i.top + "px)" : (s.left = i.left, s.top = i.top), s
            }
        }
    });
    var _ = "iframe",
    ...
    e.magnificPopup.registerModule(_, {
        ...
        proto: {
            initIframe: function() {
                t.types.push(_), b("BeforeChange", function(e, t, n) {
                    t !== n && (t === _ ? B() : n === _ && B(!0))
                }), b(s + "." + _, function() {
                    B()
                })
...
var progress = function() {
        function e() {
            n >= 78 ? clearInterval(i) : (n++, t.style.width = n + "%", r.text(n))
        }
    ...
    timer = function() {
        function e() {
            var e = new Date,
                s = t - e;
            if (s < 0) return $(".day").text("00"), $(".hour").text("00"), $(".min").text("00"), $(".sec").text("00"), $(".mili").text("00"), !1;
            var u = Math.floor(s / a),
                l = Math.floor(s % a / o),
                c = Math.floor(s % o / i),
                f = Math.floor(s % i / r),
                p = Math.floor(s % r / n);
            f < 10 && (f = "0" + f), c < 10 && (c = "0" + c), l < 10 && (l = "0" + l), $(".day").text(u), $(".hour").text(l), $(".min").text(c), $(".sec").text(f), $(".mili").text(p)
        }
        var t = new Date("08/18/2019 11:59 PM"),
            n = 10,
            r = 100 * n,
            i = 60 * r,
            o = 60 * i,
